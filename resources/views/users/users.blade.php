            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                <div class="text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-10 text-right">
                        <button onclick="toggleAddModal()" class="bg-appColorBlue text-white px-4 py-2 rounded">
                            Add New User
                        </button>
                    </div>
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex space-x-4">
                                    <a href="{{ route('users.show', $user->id) }}" class="text-primary hover:text-primary">
                                    ...
                                    <button onclick="toggleModal('{{ $user->id }}', '{{ $user->name }}', '{{ $user->email }}')" class="text-appColorBlue hover:text-appColorBlue">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden transform transition-all sm:max-w-lg sm:w-full">
                <div class="px-6 py-4">
                    ...
                    <div class="flex justify-between items-center border-b border-gray-200 dark:border-gray-700 pb-2">
                        ...
                        <button onclick="toggleAddModal()" class="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
                            <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                            </svg>
                        </button>
