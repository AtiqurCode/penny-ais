                                    ...
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex space-x-4">
                                            <a href="{{ route('accounts.show', $account->id) }}"
                                                ...
                                                <svg class="w-6 h-6 text-white-600 dark:text-white-900" aria-hidden="true"
                                            ...
                                            <button
                                                ...
                                                class="text-appColorBlue hover:text-appColorBlue">
                                                <svg class="w-6 h-6 text-appColorBlue dark:text-appColorBlue"
            ...
            <div
                ...
                <div class="px-6 py-4">
                    ...
                    <form method="POST" action="{{ route('accounting.createAccount') }}" class="mt-4">
                        ...
                        <!-- Name Field -->
                        <div class="mb-4">
                            <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Account
                                Name</label>
                        ...
                        <div class="mb-4">
                            <label for="balance"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300">Balance</label>
                        ...
                        <div class="flex justify-end space-x-3">
                            <button type="button"
                                onclick="document.getElementById('addAccountModal').style.display='none'"
            ...
            <div
                ...
                <div class="px-6 py-4">
                    ...
                    <form method="POST" action="{{ route('accounting.createTransaction') }}" class="mt-4">
                        ...
                        <div class="flex justify-end space-x-3">
                            <button type="button"
                                onclick="document.getElementById('addTransactionModal').style.display='none'"
                                class="px-4 py-2 text-sm text-gray-500 dark:text-gray-300 bg-transparent hover:text-gray-700 dark:hover:text-gray-100 rounded-md">
                                Cancel
                            </button>
                            <button type="submit"
